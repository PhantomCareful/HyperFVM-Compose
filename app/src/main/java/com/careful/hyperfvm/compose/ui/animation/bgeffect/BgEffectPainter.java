...
public class BgEffectPainter {
    ...
    public BgEffectPainter(Context context) {
        ...
        mBgRuntimeShader = new RuntimeShader(Objects.requireNonNull(loadShader));
    ...
    public void setPhoneLight(float[] fArr) {
        ...
        setPoints(new float[]{0.8f, 0.2f, 1.0f, 0.8f, 0.9f, 1.0f, 0.2f, 0.9f, 1.0f, 0.2f, 0.2f, 1.0f});
    ...
    public void showRuntimeShader(boolean darkMode) {
        this.bound = new float[]{0f, 0f, 1f, 1f};
        if (darkMode) {
